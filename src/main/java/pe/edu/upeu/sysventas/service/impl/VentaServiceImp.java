...
public class VentaServiceImp extends CrudGenericoServiceImp<Venta, Long> implements IVentaService {
    ...
    @Override
    public java.util.List<Venta> findByFechaGenerBetween(java.time.LocalDateTime inicio, java.time.LocalDateTime fin) {
        return ventaRepository.findByFechaGenerBetween(inicio, fin);
    }
}
