...
public class ProductoController {
    ...
    TextField txtNombreProducto, txtPUnit,
            txtPUnitOld, txtStock, txtStockOld,
            txtFiltroDato;
    @FXML
    ...
    @FXML
    public void actualizarProductos(ActionEvent event) {
        listar();
        Toast.showToast(stage, "✅ Productos actualizados", 2000, 200, 200);
    }
    ...
    public void initialize() {
        ...
        columns.put("Stock Actual", new ColumnInfo("stock", 100.0));
    ...
    public void editForm(Producto producto) {
        ...
        cbxCategoria.getSelectionModel().select(
                cbxCategoria.getItems().stream()
                        .filter(categoria -> Long.parseLong(categoria.getKey()) == producto.getCategoria()
                                .getIdCategoria())
                        .findFirst()
                        .orElse(null));
    ...
    public void validarFormulario() {
        ...
        formulario.setUtilidad(0.0); // Utilidad eliminada del formulario
    ...
    @FXML
    public void irAColaboradores(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/colaboradores.fxml"));
    ...
    @FXML
    public void irAFinanzas(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/finanzas.fxml"));
            loader.setControllerFactory(applicationContext::getBean);
            Parent root = loader.load();
            Scene scene = new Scene(root);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    public void cerrarSesion(ActionEvent event) {
        try {
            ...
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.setTitle("Login - SysVentas");
            stage.show();
        } catch (IOException e) {
            e.printStackTrace();
        }
